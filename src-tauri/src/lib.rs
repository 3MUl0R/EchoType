...
pub struct AppState {
    ...
    pub streaming_session_handle: Arc<Mutex<Option<dictation::session::StreamingSessionHandle>>>,
...
pub fn run() {
    ...
    let state = AppState {
        ...
        streaming_session_handle: Arc::new(Mutex::new(None)),
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::add_custom_word,
            commands::remove_custom_word,
